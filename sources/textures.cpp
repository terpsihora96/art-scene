// Initial code from https://github.com/mrdakj/Kocka-kocka-kockica/blob/master/sources/textures.cpp
// Code is after further changed
...
void load_textures()
{
    ...
    create_texture(image, texture_names, FILENAME2, 2);
...
void free_textures()
{
    glDeleteTextures(NUMBER_OF_TEXTURES, texture_names);
}
